...
let drink = "red wine"
let myName = "Troy"
let myFriendsName = "Brittany"
//Question: Name a reason why you would use const instead of let.
//Answer:I would use const if I never want that variable to change.
/*---------------------------------- Template Literals -------------------------------------*/
console.log(`-------------------------- 
...
//Answer: drink has already been declared so cannot be changed, changes to a let variable so can be changed
...
console.log(foodForTodayAndTomorrow('spaghetti', 'milk', lunchTime('pizza', 'red wine')))
